...
# Example usage
csv_file_path = 'C:\\Users\\Bheki Lushaba\\Desktop\\ukzn_course_data\\CSV\\table_page_103_table_1.csv'  # Update this path to your actual CSV file path
json_file_path = 'C:\\Users\\Bheki Lushaba\\Desktop\\ukzn_course_data\\output.json'  # Update this path to your desired JSON output file path
